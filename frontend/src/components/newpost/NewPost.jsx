    ...
    return (
        <div className={styles.container}>
            <form className={styles.form} onSubmit={handleSubmit}>
                ...
                <button type="submit" className={`${styles.button} ${content.trim().length === 0? styles.disabled : ""}`} disabled={content.trim().length === 0}><svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px"><path d="M120-160v-640l760 320-760 320Zm80-120 474-200-474-200v140l240 60-240 60v140Zm0 0v-400 400Z"/></svg></button>
            </form>
        </div>
    )
} 
